...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Set kernel size = 2,2 and Stride = 2,2 to upsample
    ...
    # Add second deconvolution layer and connect to the skip layer
...
def run():
    ...
    with tf.Session() as sess:
        # Path to vgg model
        vgg_path = r"C:\Users\priya\Documents\carnd\Term3\CarND-Semantic-Segmentation\vgg"
